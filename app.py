...
DEFAULT_EXPANDED = {
    ...
    "backgrounds": [  # {name,index,feature:{name,desc},skills:[...],tools:[...],languages:[...],equipment:[...],origin_feat:{name,desc}}
        ...
        {"name": "Charlatan", "index": "charlatan", "feature": {"name": "Con Artist", "desc": "You maintain false identities and can forge simple documents and credentials."}, "skills": ["Deception", "Sleight of Hand"], "tools": ["Disguise Kit", "Forgery Kit"], "languages": ["None"], "equipment": ["Disguise kit", "Fine clothes", "Set of weighted dice or marked cards", "Pouch (15 gp)"], "origin_feat": {"name": "Skilled", "desc": "You gain proficiency in any three skills of your choice."}},
        {"name": "Criminal", "index": "criminal", "feature": {"name": "Criminal Contacts", "desc": "You have a network of underworld associates who can provide information and favors."}, "skills": ["Stealth", "Deception"], "tools": ["Thieves’ Tools"], "languages": ["Thieves’ Cant"], "equipment": ["Crowbar", "Dark common clothes with hood", "Thieves’ tools", "Pouch (15 gp)"], "origin_feat": {"name": "Alert", "desc": "You gain a bonus to initiative and can’t be surprised while conscious."}},
        {"name": "Entertainer", "index": "entertainer", "feature": {"name": "By Popular Demand", "desc": "You can secure free lodging and food by performing for crowds."}, "skills": ["Performance", "Acrobatics"], "tools": ["Musical Instrument (choose one)", "Disguise Kit"], "languages": ["None"], "equipment": ["Musical instrument (your choice)", "Costume", "Love letter or token from an admirer", "Pouch (15 gp)"], "origin_feat": {"name": "Musician", "desc": "You gain proficiency with three musical instruments and can inspire allies during a short rest."}},
        {"name": "Guard", "index": "guard", "feature": {"name": "Watchful Eye", "desc": "You can identify threats or notice suspicious behavior more easily when protecting a person or location."}, "skills": ["Perception", "Athletics"], "tools": ["Gaming Set (choose one)"], "languages": ["Common"], "equipment": ["Spear or quarterstaff", "Uniform", "Manacles", "Pouch (10 gp)"], "origin_feat": {"name": "Alert", "desc": "You gain a bonus to initiative and can’t be surprised while conscious."}},
        {"name": "Farmer", "index": "farmer", "feature": {"name": "Rural Roots", "desc": "You can find food, shelter, and allies among common folk in rural areas."}, "skills": ["Animal Handling", "Nature"], "tools": ["Artisan’s Tools (farmer’s tools)"], "languages": ["Halfling"], "equipment": ["Walking stick (club)", "Common clothes", "Heirloom seed pouch", "Pouch (10 gp)"], "origin_feat": {"name": "Tough", "desc": "Your hit point maximum increases by 2 per level."}},
        {"name": "Guide", "index": "guide", "feature": {"name": "Wilderness Expertise", "desc": "You can find safe passage, water, and shelter in the wilds for yourself and companions."}, "skills": ["Survival", "Perception"], "tools": ["Navigator’s Tools"], "languages": ["Giant"], "equipment": ["Traveler’s clothes", "Hooded lantern", "50 feet of hempen rope", "Pouch (10 gp)"], "origin_feat": {"name": "Skilled", "desc": "You gain proficiency in any three skills of your choice."}},
        {"name": "Hermit", "index": "hermit", "feature": {"name": "Discovery", "desc": "You uncovered a hidden truth about the world or a great secret that others seek."}, "skills": ["Medicine", "Religion"], "tools": ["Herbalism Kit"], "languages": ["Draconic"], "equipment": ["Scroll case of notes", "Winter blanket", "Common clothes", "Herbalism kit", "Pouch (5 gp)"], "origin_feat": {"name": "Healer", "desc": "You can use a healer’s kit to restore more hit points and stabilize creatures efficiently."}},
        {"name": "Noble", "index": "noble", "feature": {"name": "Position of Privilege", "desc": "You command respect from those of your station and can secure audiences with nobles."}, "skills": ["History", "Persuasion"], "tools": ["Gaming Set (choose one)"], "languages": ["Elvish"], "equipment": ["Fine clothes", "Signet ring", "Scroll of pedigree", "Pouch (25 gp)"], "origin_feat": {"name": "Inspiring Leader", "desc": "You can spend 10 minutes to grant temporary hit points to up to six allies who can hear you."}},
        {"name": "Merchant", "index": "merchant", "feature": {"name": "Trader’s Network", "desc": "You have trade connections and can find local markets or assess the value of goods easily."}, "skills": ["Insight", "Persuasion"], "tools": ["Navigator’s Tools", "Artisan’s Tools (choose one)"], "languages": ["Dwarvish"], "equipment": ["Ledger and quill", "Scale", "Traveler’s clothes", "Pouch (25 gp)"], "origin_feat": {"name": "Lucky", "desc": "You gain 3 luck points to reroll d20 tests; you regain all expended luck points after a long rest."}},
        {"name": "Sage", "index": "sage", "feature": {"name": "Researcher", "desc": "You can recall or find obscure lore through academic connections and libraries."}, "skills": ["Arcana", "History"], "tools": ["None"], "languages": ["Draconic"], "equipment": ["Bottle of ink", "Quill", "Small knife", "Letter from a colleague", "Pouch (10 gp)"], "origin_feat": {"name": "Magic Initiate (Arcane)", "desc": "You learn 2 arcane cantrips and 1 arcane 1st-level spell (once per long rest). Intelligence is your spellcasting ability for these spells."}},
        {"name": "Sailor", "index": "sailor", "feature": {"name": "Ship’s Passage", "desc": "You can secure free passage on ships for yourself and companions by working as crew."}, "skills": ["Athletics", "Perception"], "tools": ["Navigator’s Tools", "Vehicles (Water)"], "languages": ["Aquan"], "equipment": ["Belaying pin (club)", "50 feet of silk rope", "Lucky charm", "Common clothes", "Pouch (10 gp)"], "origin_feat": {"name": "Athlete", "desc": "You are especially fit; you climb, jump, and stand from prone more easily and gain a small speed bonus."}},
        {"name": "Scribe", "index": "scribe", "feature": {"name": "Documented Knowledge", "desc": "You are trained in recording and analyzing information, giving you access to archives and scholars."}, "skills": ["Arcana", "History"], "tools": ["Calligrapher’s Supplies"], "languages": ["Elvish"], "equipment": ["Calligrapher’s supplies", "Sealing wax", "Sheaf of parchment (10)", "Common clothes", "Pouch (10 gp)"], "origin_feat": {"name": "Skilled", "desc": "You gain proficiency in any three skills of your choice."}},
        {"name": "Soldier", "index": "soldier", "feature": {"name": "Military Rank", "desc": "You retain the respect of soldiers and can call upon your rank to gain access or favors in military circles."}, "skills": ["Athletics", "Intimidation"], "tools": ["Gaming Set (choose one)", "Vehicles (Land)"], "languages": ["Common"], "equipment": ["Insignia of rank", "Trophy from a fallen enemy", "Common clothes", "Pouch (10 gp)"], "origin_feat": {"name": "Savage Attacker", "desc": "Once per turn when you roll damage for a melee attack, you can reroll the weapon’s damage dice and use either total."}},
        {"name": "Wayfarer", "index": "wayfarer", "feature": {"name": "World Traveler", "desc": "You have traveled widely, can recall distant customs, and find shelter among diverse peoples."}, "skills": ["Survival", "Insight"], "tools": ["Cartographer’s Tools"], "languages": ["Any one"], "equipment": ["Cartographer’s tools", "Traveler’s clothes", "Map case with regional map", "Pouch (15 gp)"], "origin_feat": {"name": "Skilled", "desc": "You gain proficiency in any three skills of your choice."}}
    ]
}
        ...
        try:
            with st.expander(f"Background — {background_name}"):
                ...
                if 'expanded_background' in locals() and expanded_background:
                    ...
                    equipment = expanded_background.get("equipment") or []
                    origin_feat = expanded_background.get("origin_feat") or {}
                    if langs:
                        st.caption("Languages: " + ", ".join(langs))
                    if tools:
                        st.caption("Tool Proficiencies: " + ", ".join(tools))
                    if equipment:
                        st.caption("Equipment: " + ", ".join(equipment))
                    if origin_feat:
                        st.write(f"Origin Feat: {origin_feat.get('name','')}")
                        ofd = origin_feat.get("desc")
                        if isinstance(ofd, list):
                            for p in ofd[:2]:
                                st.write(p)
